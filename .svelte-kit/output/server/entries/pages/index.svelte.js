import { c as create_ssr_component, a as compute_rest_props, b as spread, d as escape_object, f as each, g as add_classes, v as validate_component, h as compute_slots, i as add_attribute, m as missing_component, j as escape_attribute_value, s as setContext, e as escape } from "../../chunks/index-8c0f53bd.js";
var g80 = "";
...
${validate_component(Breadcrumb, "Breadcrumb").$$render($$result, { noTrailingSlash, skeleton }, {}, {
    default: () => {
      return `${each(items, (thing) => {
        return `${validate_component(BreadcrumbItem, "BreadcrumbItem").$$render($$result, {
          href: thing.href,
          isCurrentPage: thing.isCurrentPage
        }, {}, {
          default: () => {
            return `${escape(thing.title)}`;
          }
        })}`;
      })}`;
    }
